...
TOOL = "gather"
PRIMARY_COMMANDS = ["docs", "web", "feed", "pdf", "run", "pilot", "corpus", "corpus context", "federation"]
TELOS_CONTRACTS = {
...
def status_payload() -> dict:
    return envelope(
        ...
        native={
            ...
            "current_status": (
                "1.8.0 descriptor handoff for Python context selection, 1.7.1 newline-integrity patch, readable context selection, "
