...
spec. Whether the card is TRUE of which backends this tool can reach for is a
different question, and tests/test_backends_card.py settles that one by driving
the code.
"""
